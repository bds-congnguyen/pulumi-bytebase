...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `bytebase` with the `NAME` of your provider.
...
- binary: pulumi-resource-bytebase
  ...
  ignore: []
  ldflags:
  - -X github.com/bds-congnguyen/pulumi-bytebase/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-bytebase_darwin_amd64_v1
│   └── pulumi-resource-bytebase
├── pulumi-bytebase_darwin_arm64
│   └── pulumi-resource-bytebase
├── pulumi-bytebase_linux_amd64_v1
│   └── pulumi-resource-bytebase
├── pulumi-bytebase_linux_arm64
│   └── pulumi-resource-bytebase
├── pulumi-bytebase_windows_amd64_v1
│   └── pulumi-resource-bytebase.exe
└── pulumi-bytebase_windows_arm64
    └── pulumi-resource-bytebase.exe
```
